...
#define MErrReadInfo                                                                              \
    L"\nChoose 'Ignore' to continue with the already read file part only, 'Ignore all' to do it " \
    L"for all read errors, 'Retry' to repeat read and 'Quit' to abort."
...
#define MSkipUnsafeLink                                                                         \
    L"\nSkipping the potentially unsafe %s -> %s link. For archives from a trustworthy source " \
    L"use -ola to extract it anyway."
