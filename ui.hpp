...
enum UIASKREP_FLAGS {
    UIASKREP_F_NORENAME = 1,
    UIASKREP_F_EXCHSRCDEST = 2,
    UIASKREP_F_SHOWNAMEONLY = 4
};
...
UIASKREP_RESULT
uiAskReplaceEx(CommandData *Cmd, std::wstring &Name, int64 FileSize, RarTime *FileTime, uint Flags);
...
void uiMsgBase(uiMsgStore &Store, T1 &&a1, TN &&...aN) {
...
template <class... TN>
void uiMsg(UIMESSAGE_CODE Code, TN &&...aN) {
