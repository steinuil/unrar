...
enum {
    ...
    SOLID_COUNT = 2,
    SOLID_FILEEXT = 4,
    SOLID_VOLUME_DEPENDENT = 8,
    SOLID_VOLUME_INDEPENDENT = 16
};
...
class RAROptions {
   public:
    ...
    bool ManualPassword; // Password entered manually during operation, might need to clean for next
                         // archive.
